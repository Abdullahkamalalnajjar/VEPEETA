        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotosOfMedicalLicense = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MedicalCollege = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NameOfClinicOrHospital = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MedicalPracticeAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConsultationFees = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    AnimalBornDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Weight = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ReproductiveStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClincsImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClincsImages_AspNetUsers_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Clinics_WorkingHours", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Clinics_WorkingHours_AspNetUsers_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClinicServices_AspNetUsers_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClinicServices_Services_BaseServicesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClincsImages_ClinicId",
                table: "ClincsImages",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_Clinics_WorkingHours_ClinicId",
                table: "Clinics_WorkingHours",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_ClinicServices_BaseServicesId",
